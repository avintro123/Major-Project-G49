...
import { Moon, Sun, Menu, X, Mic, Sparkles } from "lucide-react";
        ...
        <div className={cn(
          ...
          <div className="hidden md:flex items-center gap-8">
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={cn(
                    ...
                    location.pathname === link.path ? "text-neon-blue" : "text-gray-400 hover:text-white"
                  )}
                >
                  {link.name}
                  <span className={cn(
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/login">
                <Button variant="primary" size="sm" className="shadow-lg shadow-neon-blue/20">
                  Sign In
                </Button>
              </Link>
            </div>
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={cn(
                    ...
                    location.pathname === link.path ? "text-neon-blue bg-neon-blue/10" : "text-gray-400"
                  )}
                >
                  {link.name}
                </Link>
